import { formLpSoftwareSchema, IFormLpSoftwareData } from "@/lib/interfaces/(landing)/formContacto";
...
export default function FormLpSoftware() {
    const tk = "P07AP028F8A1E-2B19-49EA-A132-0CD7FEBC088B";
    ...
    const {
        ...
        reset
    } = useForm<IFormLpSoftwareData>({
        resolver: zodResolver(formLpSoftwareSchema),
        defaultValues: {
            nombre: "",
            apellidos: "",
            correo: "",
    ...
    const onSubmit: SubmitHandler<IFormLpSoftwareData> = async (data) => {
    ...
    const onInvalid = (errors: FieldErrors<IFormLpSoftwareData>) => {
        const ordenVisual = [
            "nombre",
            "apellidos",
            "movil",
